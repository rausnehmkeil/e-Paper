...
def fillBuffer(data, black, red):
    ...
    draw_black.text((vline+0.5*padding+fontsize_clock+fontsize_clock0em50, padding+fontsize_clock), "Regen- " , font = font_clock0em33, fill = 0)
    draw_black.text((vline+0.5*padding+fontsize_clock+fontsize_clock0em50, padding+fontsize_clock+fontsize_clock0em33), "wahrschein- " , font = font_clock0em33, fill = 0)
    draw_black.text((vline+0.5*padding+fontsize_clock+fontsize_clock0em50, padding+fontsize_clock+2*fontsize_clock0em33), "lichkeit" , font = font_clock0em33, fill = 0)
    draw_black.line((vline, 3*padding+2*fontsize_clock, 870, 2*padding+2*fontsize_clock), fill = 0) #horizontal line
