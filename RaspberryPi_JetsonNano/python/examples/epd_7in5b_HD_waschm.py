...
try:
    ...
    draw_black.text((200, 0), "." + str(temperature_air_frac) + u"°C", font = font109, fill = 0)
    ...
    draw_black.text((200, 264), "." + str(temperature_water_frac) + u"°C", font = font109, fill = 0)
    draw_black.text((200, 373), "Wasser", font = font72, fill = 0)
