...
try:
    ...
    draw_black.text((270, padding), "." + str(temperature_air_frac) + u"°C", font = font0em66, fill = 0)
    ...
    draw_black.text((270, vmiddle+padding), "." + str(temperature_water_frac) + u"°C", font = font0em66, fill = 0)
