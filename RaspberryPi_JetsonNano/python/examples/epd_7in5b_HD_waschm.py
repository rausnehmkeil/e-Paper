...
try:
    ...
    draw_black.text((300, 36), u"°C", font = font72, fill = 0)
    draw_black.text((300, 72), "Luft", font = font72, fill = 0)
    draw_black.line((10, 264, 870, 264), fill = 0)
    draw_black.text((10, 228), str(temperature_water), font = font218, fill = 0)
    draw_black.text((300, 300), u"°C", font = font72, fill = 0)
    draw_black.text((300, 372), "Wasser", font = font72, fill = 0)
