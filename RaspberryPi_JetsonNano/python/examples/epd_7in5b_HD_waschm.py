...
try:
    ...
    font109 = ImageFont.truetype(os.path.join(fontdir, 'Oswald-Bold.ttf'), 109)
    ...
    draw_black.text((200, 0), "." + str(temperature_air_frac), font = font109, fill = 0)
    draw_black.text((200, 109), u"°C", font = font72, fill = 0)
    draw_black.text((200, 181), "Luft", font = font72, fill = 0)
    draw_black.line((10, 264, 870, 264), fill = 0)
    draw_black.text((10, 228), str(temperature_water_int), font = font218, fill = 0)
    draw_black.text((200, 228), "." + str(temperature_water_frac), font = font109, fill = 0)
    draw_black.text((370, 337), u"°C", font = font72, fill = 0)
    draw_black.text((370, 409), "Wasser", font = font72, fill = 0)
